...
export const mockDataStatBox = [
  {
    ...
    progress: "0.75",
    change: "+14",
    icon: (iconSize) => <MonetizationOnIcon sx={{ fontSize: iconSize }} />,
    iconSize: "",
    desc: "",
  ...
  },
  {
    ...
    change: "+21",
    icon: (iconSize) => (
      <AddShoppingCartSharpIcon sx={{ fontSize: iconSize }} />
    ),
    desc: "",
  ...
  },
  {
    ...
    progress: "0.30",
    change: "-5",
    icon: (iconSize) => <AccountBalanceIcon sx={{ fontSize: iconSize }} />,
  ...
  },
  {
    ...
    progress: "0.80",
    change: "+43",
    icon: (iconSize) => <CreditCardIcon sx={{ fontSize: iconSize }} />,
...
export const mockDataIncomes = [
  {
    id: 1,
    title: "Rentdfddddddddddddddddddddddddddddddddddddddddd",
